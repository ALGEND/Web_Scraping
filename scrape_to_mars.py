...
#Find text
        mars_wthr=soup.find("p", class_="TweetTextSize TweetTextSize--normal js-tweet-text tweet-text").text
#Display output
        mars_wthr
#Dictinary addition
        mars_list["Latest Mars Weather"] = mars_wthr
        return mars_list
    finally:
        browser.quit()
...
#Find and create a Dataframe table and convert to Html string
        ...
        mars_facts={"Measuments": 'measurements',
                  "Units": 'units'}

          
#Convert extracted table to Html string
#       fact_tbl_html=facts_d.to_html()
#       fact_tbl_html
#Dictinary addition
        mars_list["Mars Facts"] = mars_facts
        return mars_list
    finally:
        browser.quit()
